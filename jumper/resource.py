...
class Resource:
    ...
    def _load_images(self):
        ...
        # Stage2 background
        stage2_bg = pygame.image.load("jumper/images/stage2_bg.jpg")
        ...
        # Stage3 background
        stage3_bg = pygame.image.load("jumper/images/stage3_bg.png")
        ...
        self.images["platform2"] = pygame.image.load("jumper/images/platform2.png")
        self.images["platform3"] = pygame.image.load("jumper/images/platform3.png")
    ...
    def _load_sounds(self):
        self.sounds["select"] = pygame.mixer.Sound("jumper/sounds/Evasion1.ogg")
        self.sounds["go_back"] = pygame.mixer.Sound("jumper/sounds/go_back.wav")
        self.sounds["confirm"] = pygame.mixer.Sound("jumper/sounds/Bow2.ogg")
        self.sounds["change_scene"] = None
        self.sounds["count"] = pygame.mixer.Sound("jumper/sounds/Bell3.ogg")

        self.sounds["jump"] = pygame.mixer.Sound("jumper/sounds/Jump1.ogg")
        self.sounds["bb_gun"] = pygame.mixer.Sound("jumper/sounds/bb_gun.wav")
        self.sounds["shotgun"] = pygame.mixer.Sound("jumper/sounds/shotgun.wav")
        self.sounds["wave_gun"] = pygame.mixer.Sound("jumper/sounds/wave_gun.wav")
        self.sounds["get_item"] = pygame.mixer.Sound("jumper/sounds/Item3.ogg")

        self.sounds["player_death"] = pygame.mixer.Sound("jumper/sounds/player_death.wav")
        self.sounds["slime_death"] = pygame.mixer.Sound("jumper/sounds/slime_death.wav")
